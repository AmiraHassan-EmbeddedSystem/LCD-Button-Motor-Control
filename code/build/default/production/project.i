    ...
    while(1){
        ...
        if(btn_valid_status != btn_last_status){
            ...
            if((btn_valid_status == BUTTON_PRESSED) && (flag == 0)){
                flag = 1;
                Relay_Turn_On(&relay);
                lcd_8bit_send_command(&lcd_8bit, 0x01);
                lcd_8bit_send_command(&lcd_8bit, 0x1C);
                lcd_8bit_send_string_pos(&lcd_8bit, "Running", 1, 6);
                _delay((unsigned long)((15)*(80000000UL/4000.0)));
                lcd_8bit_send_command(&lcd_8bit, 0x08);
                _delay((unsigned long)((15)*(80000000UL/4000.0)));
                lcd_8bit_send_command(&lcd_8bit, 0x0C);
            }
